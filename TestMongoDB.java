...
public class TestMongoDB {
    ...
    private void testCreate() {
        mongo.create(read("name"), read("email"), read("password"), read("phone"), read("gender"), read("dob"));
    }
    ...
    private void testUpdate() {
        mongo.update(read("ID"), read("password"), read("name"), read("email"),read("phone"), read("gender"), read("dob"));
    }
